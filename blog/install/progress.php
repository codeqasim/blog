...
<head>
  ...
  <style type="text/css">
   ...
   .admin { display: flex; }
    ...
    button { cursor:pointer; width: 110px; margin-right: 10px; border: transparent; background: #4f00ff; color: #fff; border-radius: 4px; height: 60px; }
...
<div class="progress" style="height:100vh !important">
  <div class="progress-bar progress-bar-striped active" id="progress" style="min-width:10%;margin: 0 auto;">
